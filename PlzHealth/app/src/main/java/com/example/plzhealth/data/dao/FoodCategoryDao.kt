...
interface FoodCategoryDao {
    ...
    @Query("SELECT DISTINCT minor FROM food_category_table WHERE major = :major AND middle = :middle ORDER BY minor")
    suspend fun getDistinctMinor(major: String, middle: String): List<String>
